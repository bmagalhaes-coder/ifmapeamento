// ==========================================================
// BOTÕES VERDES DO MAPA DO 1º ANDAR
// ==========================================================
// Cada item das listas abaixo é um botão verde em cima do mapa.
// x/y = posição do CENTRO do botão (em % da largura/altura do
// mapa), w/h = largura/altura do botão (em %), fs = tamanho da
// letra (em vw). "pesquisa" é o nome usado para buscar os dados
// da sala (arquivo pesquisa.js); se não tiver "pesquisa", usa o
// próprio "nome" escrito no botão.
//
// - "botoes1andar"  -> usado em telas pequenas (celular), com o
//   mapa na vertical.
// - "botoesGirado"  -> usado em telas grandes (tablet/PC), depois
//   que o mapa gira -90° (veja dimensões_png_primeiro_andar.css).
//   Como o mapa vira, as posições dos botões também mudam, por
//   isso existe essa segunda lista com números diferentes.
...
const botoes1andar = [
    ...
    { nome: "Sala de Vivência\ndos Servidores\n(em construção)", x: 45.6, y: 75, w: 21, h: 6.5, fs: 2.3 },
