// ==========================================
// BOTÕES VERDES (INVISÍVEIS) DO MAPA DO TÉRREO
// ==========================================
// Esse arquivo cria os botões que ficam em cima dos blocos do
// mapa do térreo (biblioteca, quadra, cineteatro, blocos A/B e
// C/D, etc). Ao clicar, abre um pop-up com a foto daquele bloco
// e, por cima da foto, os botões de cada sala daquele bloco.
//
// - "botoesparaverpopup": um item por bloco/recorte do mapa
//   (x/y/w/h em % = posição e tamanho do botão sobre o mapa;
//   "imagem" = a foto que abre no pop-up; "scale"/"scalecelular"
//   = zoom da foto no PC/celular).
// - "botoesDosPopups": para cada foto, a lista de botões das
//   salas daquela foto (o que aparece escrito e a posição de
//   cada botão em cima da imagem do pop-up). O campo "pesquisa"
//   é o nome usado para buscar os dados da sala (arquivo
//   pesquisa.js); se não tiver "pesquisa", usa o próprio "nome".
...
const botoesDosPopups = {
    ...
    "imagens/cineteatro.png": [
        ...
        { nome:"Camarim",                x:78.6, y:89.4, w:15.5, h:6, fs:12 },
    ...
    "imagens/blocoAeB.png": [

        {
            ...
            x:22.8, y:6.5, w:20, h:6.5, fs:10
        },

        {
            nome:"Lab. de\nMedidas\nElétricas",
            pesquisa:"Laboratório de Medidas Elétricas",
            x:22.8, y:15.25, w:20, h:6.5, fs:10
        },

        {
            nome:"Lab. de\nFísica e\nEletrônica",
            pesquisa:"Laboratório de Física e Eletrônica",
            x:22.8, y:24.1, w:20, h:6.5, fs:10
        },

        {
            nome:"Lab. de\nInformática\n(Superior)",
            pesquisa:"Laboratório de Informática",
            x:22.8, y:33.1, w:20, h:6.6, fs:10
        },

        {
            nome:"Fábrica de\nInovações",
            x:22.8, y:42, w:20, h:4.5, fs:10
        },

        {
            nome:"Lab. de\nQuímica",
            pesquisa:"Laboratório de Química",
            x:22.8, y:57.1, w:20, h:4.5, fs:10
        },

        {
            nome:"Lab. de\nBiologia",
            pesquisa:"Laboratório de Biologia",
            x:22.8, y:65.7, w:20, h:4.5, fs:10
        },

        {
            nome:"Lab. de\nDesenho\nTécnico",
            pesquisa:"Laboratório de Desenho Técnico",
            x: 22.8, y:74.3, w:20, h:6.5, fs:10
        },

        {
            nome:"Lab. de\nInformática",
            pesquisa:"Laboratório de Informática",
            x:22.8, y:83.5, w:20, h:4.5, fs:10
        },

        {
            nome:"Lab. de\nInformática",
            pesquisa:"Laboratório de Informática",
            x:22.8, y:93.1, w:20, h:4.5, fs:10
        },

        { nome:"Sala 46", x:76.5, y:9.5, w:17, h:3, fs:10 },
        ...
        { nome:"Sala 53", x:77, y:90.2, w:17, h:3, fs:10 },
    ],
