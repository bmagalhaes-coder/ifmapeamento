...
//bloco C
    { nome: "corredor 9", x: 78.8, y: 49.64, w: 8, h: 33.305, cor: "escura" },
...
//bloco A
    ...
    { nome: "Lab. de Informática (superior)", x: 49, y: 56.25, w: 6.1, h: 4.4, cor: "clara" },
...
//locais entre cantina e refeitório
    ...
    { nome: "AEE/NAPNE", x: 37.3, y: 68.4, w: 4.4, h: 6.5, cor: "clara" },
...
//áreas próximas ao hall e à escada para o primeiro andar
    ...
    { nome: "E-Games", x: 10.6, y:54.713, w: 4, h: 3, cor: "clara" },
    { nome: "CAE", x: 14.3, y:54.713, w: 4.8, h: 3, cor: "clara" },
    { nome: "Serviço Social", x: 15.6, y:57.6, w: 3.5, h: 3, cor: "clara" },
    ...
    { nome: "Fechada", x: 15.6, y:69.7, w: 3.5, h: 2.5, cor: "clara" },
    ...
    { nome: "Diretoria", x: 10.6, y:74.2, w: 4, h: 3, cor: "clara" },
