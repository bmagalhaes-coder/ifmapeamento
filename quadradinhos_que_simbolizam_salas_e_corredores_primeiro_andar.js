...
const salasPrimeiroAndar = [
    ...
    { nome: "Sala de Vivência dos Servidores (em construção)",       x: 35.1,  y: 71.75, w: 21,   h: 6.5, cor: "clara" },
...
const salasPrimeiroAndarGirado = [
    ...
    { nome: "Sala de Vivência dos Servidores (em construção)",       x: 85.5,   y: 49.75, w: 17,   h: 5.5, cor: "clara" },
