// ==========================================================
// QUADRADINHOS (SALAS E CORREDORES) DO MAPA DO TÉRREO
// ==========================================================
// Cada item da lista abaixo desenha um retângulo em cima do
// mapa: x/y = posição do CANTO SUPERIOR ESQUERDO do retângulo
// (em % da largura/altura do mapa), w/h = largura/altura (em %).
// cor: "clara" = sala (bege claro) | "escura" = corredor (bege escuro).
// "nome" só aparece como dica ao passar o mouse (title do HTML).
const salasTerreo = [
//corredores maiores
...
//quadra
    ...
    { nome: "Quadra Poliesportiva", x: 66.8, y: 0.1, w: 18, h: 18.7, cor: "clara" },
...
//bloco C
    ...
    { nome: "Laboratório de Produção Mecânica", x: 80.7, y: 49.64, w: 6.1, h: 4.3, cor: "clara" },
    { nome: "SAA", x: 80.7, y: 53.6, w: 6.1, h: 4.3, cor: "clara" },
    { nome: "Laboratório de Soldagem", x: 80.7, y: 57.7, w: 6.1, h: 4.3, cor: "clara" },
...
//bloco A
    ...
    { nome: "Laboratório de Máquinas Elétricas", x: 49, y: 43.89, w: 6.1, h: 4.3, cor: "clara" },
    { nome: "Laboratório de Medidas Elétricas", x: 49, y: 48, w: 6.1, h: 4.3, cor: "clara" },
    { nome: "Laboratório de Física e Eletrônica", x: 49, y: 52.1, w: 6.1, h: 4.3, cor: "clara" },
    { nome: "Laboratório de Informática (Nível Superior)", x: 49, y: 56.2, w: 6.1, h: 4.4, cor: "clara" },
    { nome: "Fábrica de Inovações", x: 49, y: 60.4, w: 6.1, h: 4.4, cor: "clara" },
    { nome: "Laboratório de Química", x: 49, y: 67.59, w: 6.1, h: 4.3, cor: "clara" },
    { nome: "Laboratório de Biologia", x: 49, y: 71.66, w: 6.1, h: 4.3, cor: "clara" },
    { nome: "Laboratório de Desenho Técnico", x: 49, y: 75.76, w: 6.1, h: 4.3, cor: "clara" },
    { nome: "Laboratórios de Informática", x: 49, y: 79.86, w: 6.1, h: 4.3, cor: "clara" },
    { nome: "Laboratórios de Informática", x: 49, y: 83.95, w: 6.1, h: 4.3, cor: "clara" },
...
//locais entre cantina e refeitório
    ...
    { nome: "Sala de Robótica", x: 33.7, y: 74.77, w: 8, h: 2.78, cor: "clara" },
    { nome: "AEE/NAPNE", x: 37.3, y: 68.4, w: 4.4, h: 6.54, cor: "clara" },
    { nome: "Refeitório (em construção)", x: 28.9, y: 80.8, w: 12.8, h: 11.4, cor: "clara" },
...
//locais da biblioteca
    ...
    { nome: "Livros fora do sistema", x: 1.8, y: 32, w: 3.5, h: 3.1, cor: "clara" },
    { nome: "Livros fora do sistema", x: 1.8, y: 34.8, w: 3.5, h: 3, cor: "clara" },
